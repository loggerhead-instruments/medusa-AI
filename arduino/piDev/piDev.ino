...
// Pi Dev: Teensy code so can dev on Pi
// On Power Teensy give control of sd card to Pi
// Show Pi pin values on display
// Do not use Swarm or Iridium
// Do not wait for GPS
 ...
 // Wire.setDefaultTimeout(10000);
  ...
  if (runMode == 0){
    ...
    do{
      ...
      display.println("Pi Dev Mode");
      display.println();
      display.print("Status :"); display.println(piStatus);
      display.println();
      display.print("Status2:"); display.println(piStatus2);
      display.display();
      delay(1000);
    }while(1);
